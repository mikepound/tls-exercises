...
public class SSLServer {
    ...
    public void startServer() {
        try {
            ...
            // Part 2: You can add code here to limit the protocols and suites the server may use
            // Note: If the server and client don't share at least one cipher suite in common,
            // you can expect the handshake to fail.
